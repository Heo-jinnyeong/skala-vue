...
const fetchRealTimeWeather = async () => {
  ...
  try {
    const [seoulRes, suwonRes, busanRes, gwangjuRes, daeguRes] = await Promise.all([
      ...
      axios.get(`${BASE_URL}?q=Gwangju&appid=${API_KEY}&units=metric&lang=kr`),
    ...
    weatherList.value = [
      ...
      },
      {
        id: 'city_04',
        name: '광주',
        temp: gwangjuRes.data.main.temp,
        status: gwangjuRes.data.weather[0].description,
      },
      {
        id: 'city_05',
        name: '대구',
